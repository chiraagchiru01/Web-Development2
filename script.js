...
if(hero){
    hero.textContent=`${getGreeting()}, I'm Chiraag R 👋`
}
...
const projects = [
    {id:1, name:"Resume-Analyzer", category:"web", tech:["react","Node.js"]},
    {id:2, name:"Student Attendance Management System", category:"web", tech:["react","Node.js"]},
    {id:3, name:"Online Food Ordering System", category:"web", tech:["react","API"]}
]
